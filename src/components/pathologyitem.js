    ...
    return (
        <SafeAreaView style={styles.doctor}>
            ...
            <SafeAreaView style={styles.doctorinfo}>
                ...
                <Text style={styles.text}>{Moment(props.info.created_at).format('LL')}</Text>
                ...
                <KButton name="Order Test" style={{ width: screenWidth * 0.4 }} click={props.click} />
            </SafeAreaView>
        </SafeAreaView>
    )
}
